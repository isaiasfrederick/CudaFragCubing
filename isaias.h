...
namespace isaias
{
	map<string, long> execute_query(string query_str, long* tempo_gasto, Fragmentos* fragmentos)
	{
	...
	map<string, long> execute_query(gpu::GpuVars* gpu_vars, string query_str, long* tempo_gasto, Fragmentos* fragmentos)
	{
		Query query;
		ContadoresTempo contadores;
		map<string, long> map_resultado;
